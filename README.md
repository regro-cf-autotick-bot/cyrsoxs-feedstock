...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cyrsoxs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cyrsoxs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `cyrsoxs` available on your platform:
...
```
pixi search cyrsoxs --channel conda-forge
```
